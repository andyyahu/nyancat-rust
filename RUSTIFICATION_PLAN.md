...
1. FrameBuffer 抽象
2. Renderer / RenderLoop 拆分
3. animation frame consistency tests
4. telnet I/O abstraction
5. sys layer typed fd / signal
6. performance benchmark harness
7. app-level error enum / CLI option spec，視後續複雜度決定
