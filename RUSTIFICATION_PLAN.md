...
1. animation frame consistency tests
2. telnet I/O abstraction
3. sys layer typed fd / signal
4. performance benchmark harness
5. app-level error enum / CLI option spec，視後續複雜度決定
