...
1. performance benchmark harness
2. app-level error enum / CLI option spec，視後續複雜度決定
3. FrameSymbol / animation newtype，只有在能明確降低 frame data 風險時再做
